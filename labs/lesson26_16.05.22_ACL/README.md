...
Пинги с PC-A и PC-B проходят до всех интерфейсов маршрутизатором и коммутаторов, а также друг до друга.

### 8. Настройка и проверка списков расширенного контроля доступа

По условиям задания необходимо реализовать 4 политики безопасности. Так как доступ из одной сети в другую может осуществляться только через подинтерфейсы маршрутизатора R1, то и все списки доступа будем настраивать на нем.
