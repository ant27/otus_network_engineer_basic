...
Для обмена данными между работы двух производственных (не административных) сервисов нужно обеспечить связность маршрутизаторов PROD1-RT, PROD2-RT, PROD1-2-RT и серверов TCP-PROD, FTP-PROD, HTTPS-PROD. Также все три сервера должны иметь доступ к NTP-серверу, а сервер FTP должен иметь исходящий доступ к интернету. Также все сервера и маршрутизаторы должны быть доступны из Management сети для контроля.

### Конфигурация сетей и интерфейсов ###

#### Конфигурация для производственного сервиса Production Service 1 ####
