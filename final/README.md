### Цели работы ###
1. Построение совмещенной технологической и административной сети.
...
### Настройка маршрутизаторов как router-on-a-stick для работы сервисов Technology_service_1 и Technology_service_2 ### 
